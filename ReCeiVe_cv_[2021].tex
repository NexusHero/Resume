...
\aboutMe{Staatsangehörigkeit: Deutsch \\ Geburtstag: 07.05.1991 \\ Aufenthaltsbewilligung: G (Grenzgänger)}
\skillset[label/0\hfill 5 Jahre]{ Machine Learning: Tensorflow/.2, OS: Linux/.9, Tools: git/.9, Azure Devops/.9,  Docker/.6, Qt-boost-openCV-OPC/.8, Python/.5, C\#/.7, C++/.9}
