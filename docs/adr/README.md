...
| [0055](0055-vivid-redesign-and-ia-restructure.md)                    | Vivid design-system redesign + IA restructure                                                                                                                        | Accepted |
| [0056](0056-availability-hardening-batch.md)                         | Availability hardening: PDF self-heal, migration lock, healthcheck, graceful shutdown, shared rate limit, multi-tenant scheduler, circuit breaker, connection budget | Accepted |
