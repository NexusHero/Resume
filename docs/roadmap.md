...
| 0.9 | **Clean-code review pass** — the codebase grew fast; audit for SRP, naming, duplication, dead code and controller/service boundaries; refactor with no behaviour change, coverage held. Do before the next big feature. | `server/src/**`                          | M      | ⬜                                    |
