...
const APPLICATIONS = [
  ...
  { id: 'a2', firma: 'Nordlicht Software', stelle: 'Backend Engineer', ort: 'Hamburg', date: '09.06.2026', status: 'review', next: 'In screening', docs: 3 },
  { id: 'a3', firma: 'Falk & Partner', stelle: 'Platform Engineer', ort: 'Munich', date: '05.06.2026', status: 'offer', next: 'Offer received', docs: 4 },
  { id: 'a4', firma: 'Meridian Labs', stelle: 'Distributed Systems Eng.', ort: 'Remote', date: '02.06.2026', status: 'new', next: 'Submitted', docs: 3 },
  { id: 'a5', firma: 'Hansa Digital', stelle: 'C++ Tech Lead', ort: 'Bremen', date: '28.05.2026', status: 'rejected', next: 'Unfortunately rejected', docs: 3 },
];

const DOCS = [
  { id: 'd1', name: 'Resume', tag: 'CV', sub: 'Aktualisiert · 1 Seite', pinned: true },
  { id: 'd2', name: 'Cover letter', tag: 'Letter', sub: 'Tailored per role', pinned: true },
